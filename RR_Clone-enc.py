...
│ ╭──────────────────────────────────────────────────────────────────────────────────╮ │
│ │                                                                                  │ │
│ │                •   STATUS : PRIBADI WHATSAPP : +8801840-215106  •                 │ │
│ │                •   _____ _______  ____________________         •                 │ │
│ │                •   __  // /__   |/  /__  __ )__  ____/         •                 │ │
│ │                •   _  // /__  /|_/ /__  __  |_  /_             •                 │ │
│ │                •   /__  __/  /  / / _  /_/ /_  __/             •                 │ │
│ │                •     /_/  /_/  /_/  /_____/ /_/ VERSION 5.0.5  •                 │ │
│ │                •                                               •                 │ │
│ │                •   GITHUB : HTTPS://GITHUB.COM/SHAHZADA-AHMED   •                 │ │
│ ╰──────────────────────────────────────────────────────────────────────────────────╯ │
╰──────────────────────────────────────────────────────────────────────────────────────╯
╭─────────────────────  • YANG INGIN MENGUNAKAN HUBUNGI CHANG •  ──────────────────────╮
│ ╭──────────────────────────────────────────────────────────────────────────────────╮ │
│ │ [S] STATUS PREMIUM                                                               │ │
│ │ [W] WHATSAPP : +8801840-215106                                                    │ │
│ ╰──────────────────────────────────────────────────────────────────────────────────╯ │
╰──────────────────────────────────────────────────────────────────────────────────────╯
"""%(O))
...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://raw.githubusercontent.com/SHAHZAD-AAHME/SAJJAD-ISLAM/main/Approved.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
        ...
        os.system('xdg-open https://wa.me/+8801840215106?text=Assalamualaikum Sir Approve my Token and my Token :'+to)
        reg()
...
def reg2():
    ...
    print (' TOKEN : ' + id)
    print(' WHATSAPP :01840-215106')
    input(' Press Enter To Send Token ')
    os.system('xdg-open https://wa.me/+8801840215106?text=Assalamualaikum Sir Approve my Token and my Token :'+id)
...
def chigozie():
    ...
    try:
        ...
        nama = requests.get('https://graph.facebook.com/me?access_token=%s'%(tokn)).json()
